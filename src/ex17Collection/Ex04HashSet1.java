...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		String strObject2 = new String("KOSMO061기")
		Date dateObject = new Date();
		int number = 100; //정수타입은 컬렉션에 저장시 Integer객체로 Boxing 된다.
		...
		/*
		 개발자가 직접 정의한 객체의 중복저장
		 	:사용자 정의 클래스인 경우 hashCode, equals 메서드를
		...
		while(itr.hasNext()) { //추출할 객체가 있는지 확인 후
			...
			/*
			 Set에 저장된 모든 객체넌 Object형으로 업캐스팅 되므로
			...
			else {System.out.println("넌 뭐임??-__-;");
			}
		}
